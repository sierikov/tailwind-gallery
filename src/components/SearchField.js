    ...
    return (
      <form onSubmit={onSubmit} className="mt-6">
        <div className="sm:flex">
          <input onChange={e => setText(e.target.value)} type="text" required placeholder={placeholder} className="block w-full px-4 py-3 text-base leading-6 appearance-none border border-gray-300 shadow-none bg-white rounded-md placeholder-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-green-800 sm:max-w-xs"/>
